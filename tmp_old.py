...
if bb: 
    ...
    _, _, yaw = bot.get_imu_attitude_data()
    run_straight_robot(bot, target_yaw=yaw, base_speed=20, target_distance=0.04)
...
# init_yaw = -107.96243731185001
_, _, yaw = bot.get_imu_attitude_data()
rotate_robot(bot, init_yaw + 180 - yaw, spd=0.2, delay=1)      # Rotate LEFT
_, _, yaw = bot.get_imu_attitude_data()
run_straight_robot(bot, target_yaw=yaw, base_speed=37, target_distance=0.36 - 0.02)
# run_straight_robot(bot, target_yaw=yaw, base_speed=37, target_distance=0.4 - dist_adjust)
rotate_robot(bot, 90, spd=0.2, delay=1)      # Rotate LEFT
...
_, _, yaw = bot.get_imu_attitude_data()
run_straight_robot(bot, target_yaw=yaw, base_speed=-20, target_distance=0.4)
